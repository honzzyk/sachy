 ...
 */
package com.supareno.pgnparser_nejsem_autorem.jaxb;
...
/**
 * The {@code Game} class is a object that represents a PGN game with all the attributes (event, site, date, ...) and a List of Hits.
 * <p>
...
@XmlType(name = "", propOrder = { "event", "site", "date", "round", "white", "whiteElo", "black", "blackElo", "result", "eco", "hits" })
...
public class Game implements Comparable<Game>, Serializable {
	...
	/**
	 * pomocna, slouzi pro ulozeni pgn jako stringu bez uprav, jen orezani odentrovani
	 */
	public String rawPGN;
	 ...
	 * 
	 * @param value
	 *            the site name where the game took place.
	 */
	 ...
	 * <p>
	 * The format of this date is: {@code YYYY.MM.DD}. If one of the element of the date is unknown, it could be replaced by {@code ??}.
	 * </p>
	 * 
	 ...
	 * 
	 * @param value
	 *            the date of the game as String format.
	 */
	...
	public String getWhiteFirstName() {
		try {
	...
	public String getBlackFirstName() {
		try {
			String[] s = black.split(",");
			return s[1].trim();
		} catch (Exception e) {
			return "?";
		}
	 ...
	 * 
	 * @param value
	 *            the Hits object to add to the Game object.
	 */
	 ...
	 * 
	 * @param value
	 *            the Hit object to add to the Game object.
	 */
